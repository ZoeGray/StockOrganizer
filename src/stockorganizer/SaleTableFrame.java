/**
 * SaleTableFrame displays the table with all the user's sales and displays
 ...
 */
public class SaleTableFrame extends JFrame implements ActionListener {
    ...
    private final String[] tableHeaders = {"ID", "Stock Ticker","Date of Sale",
        "Quantity of Shares Sold","Sales Price per Share",
        "Proceeds","Realized Gain or Loss"};
     ...
     */
    public SaleTableFrame() {
        super("Sale Transaction Frame"); 
...
//        dFrame = new DividendTableFrame();
        ...
        // Setting label text
        tableNameLabel = new JLabel("<html>Sale Transaction Table</html>", SwingConstants.CENTER);
        ...
        data = link.getDbData(InfoDb.SALE_TABLE, InfoDb.SALE_HEADER);
        dataModel = new DefaultTableModel(data, tableHeaders);

        // Putting data into JTable
        saleTable = new JTable(dataModel);
        ...
        saleTableButton.setEnabled(false);
        
        // Setting JTable characteristics
        saleTable.setBounds(30, 40, 200, 300);
        ...
        tableHeader = saleTable.getTableHeader();
...
//        actionPanel.add(marketValueButton);
        ...
        HomeFrame.setSaleFrame(this);
    }
    
    public void refreshDataTable() {
        // Getting data from database
        this.data = this.link.getDbData(InfoDb.SALE_TABLE, InfoDb.SALE_HEADER);
