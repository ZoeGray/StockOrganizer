/**
 * PurchaseTableFrame displays purchase transaction table. It contains the same
 * actions as the other main four frames (purchase, sale, dividend, running stock)
 * tables. User can choose to view another table or alter the database tables.
 */
 ...
 */
public class PurchaseTableFrame extends JFrame implements ActionListener {
    ...
    private final String[] tableHeaders = {"ID","Stock Ticker",
        "Date of Purchase","Quantity of Shares Purchased",
        "Cost Basis per Share","Cost Basis of Purchase"};
     ...
     */
    public PurchaseTableFrame() {
        super("Purchase Table Frame"); 
...
//        dFrame = new DividendTableFrame();
        ...
        // Setting label text
        tableNameLabel = new JLabel("<html>Purchase Transaction Table</html>", SwingConstants.CENTER);
        ...
        data = link.getDbData(InfoDb.PURCHASE_TABLE, InfoDb.PURCHASE_HEADER);
        dataModel = new DefaultTableModel(data, tableHeaders);

        // Putting data into JTable
        purchaseTable = new JTable(dataModel);
        ...
        purchaseTableButton.setEnabled(false);
        
        // Setting JTable characteristics
        purchaseTable.setBounds(30, 40, 200, 300);
        purchaseTable.setBackground(Color.WHITE);
        purchaseTable.setGridColor(Color.BLACK);
        ...
        tableHeader = purchaseTable.getTableHeader();
...
//        actionPanel.add(marketValueButton);
        ...
        HomeFrame.setPurchaseFrame(this);
    }
    
    public void refreshDataTable() {
        // Getting data from database
        this.data = this.link.getDbData(InfoDb.PURCHASE_TABLE, InfoDb.PURCHASE_HEADER);
