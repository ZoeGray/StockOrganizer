/**
 * DividendTableFrame displays table with all users dividend information for
 * every stock
 */
 ...
 */
public class DividendTableFrame extends JFrame implements ActionListener {
    ...
    private final String[] tableHeaders = {"Stock Ticker","Dividend per Share",
        "Dividends Recieved"};
     ...
     */
    public DividendTableFrame() {
        super("Dividend Table Frame"); 
        
//        rhFrame = new RunningHoldingsTableFrame();
//        pFrame = new PurchaseTableFrame();
//        sFrame = new SaleTableFrame();
//        dFrame = new DividendTableFrame();
        ...
        // Setting label text
        tableNameLabel = new JLabel("<html>Dividend Holdings Table</html>", SwingConstants.CENTER);
        ...
        data = link.getDbData(InfoDb.DIVIDEND_TABLE, InfoDb.DIVIDEND_HEADER);
        dataModel = new DefaultTableModel(data, tableHeaders);

        // Putting data into JTable
        dividendTable = new JTable(dataModel);
        ...
        dividendTableButton.setEnabled(false);
        
        // Setting JTable characteristics
        dividendTable.setBounds(30, 40, 200, 300);
        dividendTable.setBackground(Color.WHITE);
        dividendTable.setGridColor(Color.BLACK);
        dividendTable.setRowHeight(30);
        dividendTable.setFillsViewportHeight(true);
        dividendTable.setDefaultEditor(Object.class, null);
        // set font
        
        // Setting table headers
        tableHeader = dividendTable.getTableHeader();
        ...
        // Set scrollpane
        scrollPane = new JScrollPane(dividendTable);
        ...
        // Adding the buy, sell, and edit dividend annualizedRetButtonoptions to panel
...
//        actionPanel.add(marketValueButton);
        ...
        HomeFrame.setDividendFrame(this);
    }
    
    public void refreshDataTable() {
        // Getting data from database
        this.data = this.link.getDbData(InfoDb.DIVIDEND_TABLE, InfoDb.DIVIDEND_HEADER);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        // Changing table frame
        if (command.equals("<html>RUNNING HOLDINGS TABLE</html>")) {
            RunningHoldingsTableFrame rhtfObj = new RunningHoldingsTableFrame();
            this.dispose();
        }
